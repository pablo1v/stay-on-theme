...
const mainColorHsl = [220, 35, 10];
const blueTokenColorHsl = [205, 100, 50];
...
const viewColors = {
  ...
  blue: makeColorVariants(hslToHex(mainColorHsl[0], 75, 55)),
};

const colors = {
  white: hslToHex(0, 0, 100),
  red: hslToHex(355, 100, 60),
  yellow: hslToHex(55, 100, 60),
  orange: hslToHex(35, 100, 50),
  cyan: hslToHex(185, 100, 50),
  pink: hslToHex(310, 90, 70),
...
export const theme = makeThemeConfig({
  ...
  colors: {
    ...
    'tab.activeBorderTop': viewColors.blue.default,
    'activityBarBadge.background': viewColors.blue.default,

    'editor.background': viewColors.main.default,

    'statusBar.debuggingBackground': viewColors.blue['-200'],
